...
import LanguageSelectorES from "./LanguageSelectorES";

function NavbarES({ currentPage, height = 100 }) {
  useEffect(() => {
            ...
            <nav id="navbar" className="navbar order-last order-lg-0">
              <ul>
                <li style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 1)' }}>
                  <Link id="home" to="/es/home">
                    Inicio
                  </Link>
                </li>
                <li style={{ textShadow: '2px 2px 4px   rgba(0, 0, 0, 1)' }}>
                  <Link id="tour" to="/es/services">
                    Servicios
                  </Link>
                </li>
                <li style={{ textShadow: '2px 2px 4px  rgba(0, 0, 0, 1)' }}>
                  <Link id="aboutus" to="/es/contact">
                    Contacto
                  </Link>
                </li>
              </ul>
