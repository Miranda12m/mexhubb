                        ...
                        <Col style={{ marginBottom: '4%' }}>
                            <Link to='/es/restaurants'>
                                <MDBCard className="mdb-card" style={{ minWidth: '300px', marginLeft: '5%', marginRight: '5%', marginBottom: '5%' }}>
                                    ...
                                    <MDBCardBody>
                                        <MDBCardTitle><strong>Service</strong></MDBCardTitle>
                                        <MDBCardText>
...
export default RecomendationES