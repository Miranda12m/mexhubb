...
export default function HousesES() {
            ...
            *::after {
            ...
            <div class="containerh" style={{ alignItems: 'center' }}>
                <div class="tileh feautered mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Departamento Residencial Terre</h4>
                        <p>Departamento de tres recámaras en excelente estado ubicado al lado de Televisa. Ubicado en el piso 13 es interior.</p>
                        <div class="specs">
                ...
                <div class="tileh mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Departamento Paseo Reforma</h4>
                        <p>Departamento Loft New York ubicado en el emblemático edificio Plaza Residences Ciudad de México, sobre Paseo de la Reforma.</p>
                        <div class="specs">
                ...
                <div class="tileh mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Departamento Condesa</h4>
                        <p>Es un espectacular y moderno proyecto de departamentos de lujo en una de las mejores zonas, más céntrica y de mayor plusvalía en la CDMX.</p>
                        <div class="specs">
