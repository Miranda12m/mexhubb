...
export default function ImalES() {
    return (
        <>
            <style>
                {`
                    ...
                    <div class="box mdb-card">
                        ...
                        <div class="overlay">
                            ...
                            <p class="Stext">Servicios de Importación y Exportación,
                                 Mueva sus artículos del hogar al extranjero,
                                 Traducciones al español y
                    ...
                    <div class="box mdb-card">
                        ...
                        <div class="overlay">
                            ...
                            <p class="Stext"> Demandas,
                                 Casos de accidentes y lesiones personales,
                                 Delitos menores, infracciones y cargos
                            </p>
                        </div>
                    </div>
                </div>
