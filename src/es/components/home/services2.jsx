...
export default function Services2ES() {
  AOS.init();
  return (
    <>
      <style>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="site-heading text-center" data-aos="fade-right">
                  <h2>Que <span>Ofrecemos</span></h2>
                  <h4>Simplificando la vida, Soluciones a medida</h4>
                </div>
              </div>
            </div>
            <div className="tabla-con-cartas"  data-aos="fade-up">
              <div class="row our-offer-items less-carousel ">
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/es/housing" style={{ color: 'white' }} >
                    <div class="item fondo" >
                      ...
                      <h4>Servicios de Alojamiento</h4>
                      <p>
                      Servicios de Vivienda, donde encontrar tu casa ideal en la Ciudad de México no es solo un proceso, es una experiencia.                      </p>
                    </div>
                  </Link>
                </div>

                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/es/tours" style={{ color: 'white' }}>
                    <div class="item fondo2" >
                      ...
                      <h4>Tours Mexhubb</h4>
                      <p>
                      Mexhubb Tours, donde cada viaje es una exploración y una experiencia enriquecedora que profundiza en la esencia cultural.                      </p>
                    </div>
                  </Link>
                </div>

                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to='/es/events' style={{ color: 'white' }}>
                    <div class="item fondo3">
                      ...
                      <h4>Eventos Mexhubb</h4>
                      <p>
                      Nacidos de la pasión por compartir nuestras experiencias con el mundo, ofrecemos acceso a lugares exclusivos y actividades especiales.                      </p>
                    </div>
                  </Link>
                </div>

                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to='/es/legal' style={{ color: 'white' }}>
                    <div class="item fondo4">
                      ...
                      <p>
                      Nuestro enfoque colaborativo garantiza que usted reciba orientación y apoyo expertos en diversos asuntos legales.                      </p>
                    </div>
                  </Link>
                </div>

                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/es/specialized" style={{ color: 'white' }}>
                    <div class="item fondo5">
                      ...
                      <p>
                      Entendemos que sus necesidades son únicas y estamos aquí para ofrecer una amplia gama de servicios especializados.                      </p>
                    </div>
                  </Link>
                </div>

                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/es/contact" style={{ color: 'white' }}>
                    <div class="item fondo6">
                      ...
                      <h4>Contactanos</h4>
                      <p>
                      No importa cuán específica sea su solicitud, Mexhubb se dedica a hacer un esfuerzo adicional para ayudarlo.                      </p>
                    </div>
                  </Link>
                </div>
              </div>
