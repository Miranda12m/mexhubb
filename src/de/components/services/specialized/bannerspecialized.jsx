...
export default function BannerSpecializedDE() {
  return (
    <>
      <style>
        {`
      ...
      <MDBCarousel style={{ position: 'relative', overflow: 'hidden', width: '100%', height: '50vh' }}>
        <MDBCarouselItem itemId={1}>
          ...
          <img
            src='https://i.ibb.co/619vKjB/image00062-2.webp'
        ...
        <MDBCarouselItem itemId={2}>
          <div className="overlay"></div>
          <img
            src='https://i.ibb.co/qJPJttM/image00095-2.webp'
            className='d-block vw-100'
            alt='...'
          />
        </MDBCarouselItem>
        <MDBCarouselItem itemId={3}>
          <div className="overlay"></div>
          <img
            src='https://i.ibb.co/RHzTQWH/image00056-4.webp'
            className='d-block vw-100'
            alt='...'
          />
        </MDBCarouselItem>
      ...
      <div className="container" style={{ height: '50%', position: 'absolute', zIndex: '2', top: '20%', left: '50%', transform: 'translate(-50%, -50%)' }}>        <br></br> <br></br> <br></br> <br></br> <br></br> <br></br> <br></br> <br></br> <br></br> <br></br>
        <div className="row">
          <div className="col-md-12 text-white text-center" data-aos="fade-right">
            <h1 className="m-b-20" >
              <strong style={{textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)', fontSize: '1.8em', fontWeight:'bold', color: 'white'}}>Spezialisierte Dienstleistungen</strong>
            </h1>
