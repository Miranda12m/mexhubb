            ...
            <Container>
                ...
                <div class="section">
                    <div class="box mdb-card" data-aos="fade-up">
                        ...
                        <div class="overlay">
                            <h3 class="Ttext">Coworking spaces</h3>
                            <p class="Stext">We provide shared workspaces for those who need to stay productive during their stay.
                            </p>
                        </div>
                    </div>
                    <div class="box mdb-card" data-aos="fade-up">
                        ...
                        <div class="overlay">
                            <h3 class="Ttext">Bar Hopping</h3>
                            <p class="Stext">We take you to the best local bars to enjoy Mexican nightlife.
                            </p>
                        </div>
                    </div>
                    <div class="box mdb-card" data-aos="fade-up">
                        ...
                        <div class="overlay">
                            <h3 class="Ttext">Sports activities</h3>
                            <p class="Stext">We organize sports events to keep you active and full of energy.
                            </p>
                        </div>
                    </div>
                </div>
