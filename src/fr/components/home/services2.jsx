...
export default function Services2FR() {
  AOS.init();
  return (
    <>
      <style>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="site-heading text-center" data-aos="fade-right">
                  <h2>Ce que nous <span>Offre</span></h2>
                  <h4>Simplifier la vie, adapter les solutions</h4>
                </div>
              </div>
            </div>
            <div className="tabla-con-cartas"  data-aos="fade-up">
              <div class="row our-offer-items less-carousel ">
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/fr/housing" style={{ color: 'white' }} >
                    <div class="item fondo">
                      ...
                      <h4>Services de logement</h4>
                      <p>
                      Les services de logement de Mexhubb, où trouver votre maison idéale à Mexico n'est pas seulement un processus, c'est une expérience.
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/fr/tours" style={{ color: 'white' }}>
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to='/fr/events' style={{ color: 'white' }}>
                    <div class="item fondo3">
                      ...
                      <h4>Événements Mexhubb</h4>
                      <p>
                      Nés de la passion de partager nos expériences avec le monde, nous offrons l'accès à des lieux exclusifs et à des activités spéciales.
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to='/fr/legal' style={{ color: 'white' }}>
                    <div class="item fondo4">
                      ...
                      <p>
                      Notre approche collaborative garantit que vous recevez des conseils et un soutien d’experts dans diverses questions juridiques.
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/fr/specialized" style={{ color: 'white' }}>
                    <div class="item fondo5">
                      ...
                      <p>
                      Nous comprenons que vos besoins sont uniques et nous sommes là pour vous offrir une large gamme de services spécialisés.
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                  <Link to="/fr/contact" style={{ color: 'white' }}>
                    <div class="item fondo6">
                      ...
                      <p>
                      Quelle que soit la spécificité de votre demande, Mexhubb s'engage à faire un effort supplémentaire pour vous aider.
                      </p>
                    </div>
                  </Link>
                </div>
