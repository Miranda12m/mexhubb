...
import ContactButton2FR from '../../contactbutton2';
import Carousel from 'react-bootstrap/Carousel';

export default function HousesFR() {
            ...
            *::after {
            ...
            <div class="containerh" style={{ alignItems: 'center' }}>
                <div class="tileh feautered mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Département Résidentiel de Terre</h4>
                        <p>Département de trois chambres en excellent état situé à côté de Televisa. Situé au 13ème étage est intérieur.</p>
                        <div class="specs">
                ...
                <div class="tileh mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Département Paseo Reforma</h4>
                        <p>New York Loft Department situé dans le bâtiment emblématique Plaza Residences México City, sur le Paseo de la Reforma, il est tout simplement impressionnant.</p>
                        <div class="specs">
                ...
                <div class="tileh mdb-card" style={{ marginBottom: '30px' }} data-aos='fade-up'>
                    ...
                    <div class="bodyh">
                        <h4>Département de Condesa</h4>
                        <p>Il s'agit d'un projet spectaculaire et moderne de départements de luxe dans l'un des meilleurs quartiers, le plus central et de plus grande plus-value du CDMX.</p>
                        <div class="specs">
