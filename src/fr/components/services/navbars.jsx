      ...
      <div >
        <div class="site-footer-top-top">
          ...
          <Col className='margenextra' style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/services' className="linksns" ><IoReorderThree /> Tout </Link>
          </Col>
          <Col className='margenextra' style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/housing' className="linksns" ><FaHouseChimney /> Logement</Link>
          </Col>
          <Col className='margenextra' style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/tours' className="linksns"><FaMapMarkedAlt /> Visites</Link>
          </Col>
          <Col  style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/events' className="linksns"><MdEvent /> Événements</Link>
          </Col>
          <Col style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/legal' className="linksns"><IoDocumentText /> Légal</Link>
          </Col>
          <Col style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', borderLeft:'1px solid black', borderRight:'1px solid black' }}>
            <Link to='/fr/specialized' className="linksns"><RiContactsFill /> Spécialisé</Link>
          </Col>
        </div>
          </div>
        </div>
